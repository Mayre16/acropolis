...
export const CIRCULO_SUBMARCA_LOGO = {
...
export const CIRCULO_QUIENES_SOMOS_PATH = `${CIRCULO_AMIGOS_PATH}/quienes-somos`;

export const CIRCULO_HOME_PATH = CIRCULO_AMIGOS_PATH;
export const CIRCULO_INSCRIPCION_HASH = "inscribete";
export const CIRCULO_INSCRIPCION_HREF = `${CIRCULO_AMIGOS_PATH}#${CIRCULO_INSCRIPCION_HASH}`;
