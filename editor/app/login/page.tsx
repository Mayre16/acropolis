          ...
          {step === STEPS.login && (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <p className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs leading-relaxed text-slate-600">
                Este es un sistema de uso interno. No compartas tu contraseña ni
                códigos de verificación. Si no reconoces este acceso, contacta
                al administrador.
              </p>
            </form>
          )}
          ...
          {step === STEPS.twoFa && (
            <form onSubmit={handleVerify2fa} className="space-y-4">
              <p className="text-sm text-slate-600">
                Introduce el código de 6 dígitos de Microsoft Authenticator o
